...
class HiSilderViewsss @JvmOverloads constructor(
    ...
    private fun parseMenuItemAttr(attrs: AttributeSet) :MenuItemAttr{
        ...
        var menuItemWidth = typeArray.getDimensionPixelOffset(R.styleable.HiSliderView_menuItemWidth,MENU_WIDTH)
        var menuItemHeight = typeArray.getDimensionPixelOffset(R.styleable.HiSliderView_menuItemHeight,MENU_HEIGHT)
        var menuItemTextColor = typeArray.getColorStateList(R.styleable.HiSliderView_menuItemTextColor)?:generateColorStateList()
        var menuItemTextSize = typeArray.getDimensionPixelOffset(R.styleable.HiSliderView_menuItemTextSize,MENU_TEXT_SIZE)
        var menuItemSelectTextSize = typeArray.getDimensionPixelOffset(R.styleable.HiSliderView_menuItemSelectTextSize,MENU_TEXT_SIZE)
        var menuItemIndicator = typeArray.getDrawable(R.styleable.HiSliderView_menuItemIndicator)?:ContextCompat.getDrawable(context,R.drawable.shape_hi_slider_indicator)
        var menuItemBackgroundColor = typeArray.getColor(R.styleable.HiSliderView_menuItemBackgroundColor,BG_COLOR_NORMAL)
        var menuItemBackgroundSelectColor = typeArray.getColor(R.styleable.HiSliderView_menuItemSelectBackgroundColor,BG_COLOR_SELECT)
        typeArray.recycle()
        return MenuItemAttr(
            menuItemWidth,
            menuItemHeight,
